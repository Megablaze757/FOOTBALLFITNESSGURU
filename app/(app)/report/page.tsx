    ...
    <div className="animate-fade-up space-y-5">
      ...
      <div className="card-premium space-y-6 p-6 sm:p-8">
        <div className="flex items-start justify-between border-b border-white/10 pb-5">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-extrabold">Apex</span>
            </div>
        ...
        <p className="text-xs text-slate-500">
          Generated by Apex from {checkIns.length} check-ins and {training.length} logged sessions over the last 4 weeks.
