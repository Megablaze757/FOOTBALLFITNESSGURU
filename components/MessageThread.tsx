  ...
  return (
    <section className="card p-5">
      ...
      <form onSubmit={(e) => { e.preventDefault(); send(); }} className="flex gap-2">
        ...
        <button type="submit" disabled={!body.trim() || sending} className="min-h-[44px] rounded-2xl bg-gradient-to-br from-pitch-400 to-pitch-600 px-4 font-semibold text-on-accent disabled:opacity-50">↑</button>
      </form>
    </section>
  );
}
