...
export const EXERCISES: Exercise[] = [
  ...
  { id: "single_leg_rdl", name: "Single-leg RDL", category: "Strength", demo: "hinge", equipment: "Weights",
    ...
    why: "Loads the hamstring at length on one leg, and trains the balance a two-legged hinge never asks for." },
  ...
  { id: "dead_bug", name: "Dead bug", category: "Mobility", demo: "plank", equipment: "None",
    ...
    why: "Teaches the core to stay braced while the limbs move, which is what the trunk does under every load." },
