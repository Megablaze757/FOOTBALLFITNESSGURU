...
const META: Record<string, MovementMeta> = {
  ...
  leg_swings: { slot: "warmup", pattern: "mobility", targets: [], load: { groin: 1 }, level: 1, prog: "reps", dose: d(1, 10, REST.none, { unit: "each side" }) },
  world_greatest_stretch: { slot: "warmup", pattern: "mobility", targets: [], load: { groin: 1 }, level: 1, prog: "reps", dose: d(1, 5, REST.none, { unit: "each side" }) },
  ...
  glute_bridge: { slot: "warmup", pattern: "hinge", targets: ["injury_recovery"], load: { glute: 2 }, level: 1, prog: "reps", dose: d(2, 12, REST.none), region: "legs" },
  ...
  a_skips: { slot: "warmup", pattern: "sprint", targets: ["speed"], load: { ankle: 1, calf: 2, glute: 1 }, level: 1, prog: "reps", dose: d(3, 20, REST.short, { unit: "metres" }), region: "conditioning" },

  // --- Primary: the hard, skilled work, done fresh --------------------------
  back_squat: { slot: "primary", pattern: "squat", targets: ["strength"], load: { knee: 2, hip: 1, quad: 2, groin: 1, glute: 2 }, level: 2, prog: "load", dose: d(4, 5, REST.long, { rpe: 8, tempo: "3s down · drive up" }), region: "legs" },
  front_squat: { slot: "primary", pattern: "squat", targets: ["strength"], load: { knee: 2, quad: 3, groin: 1, glute: 1, wrist: 2 }, level: 2, prog: "load", dose: d(4, 5, REST.long, { rpe: 8, tempo: "2s down · drive up" }), region: "legs" },
  deadlift: { slot: "primary", pattern: "hinge", targets: ["strength"], load: { hamstring: 2, lower_back: 2, glute: 2 }, level: 3, prog: "load", dose: d(4, 4, REST.long, { rpe: 8, tempo: "Controlled down" }), region: "legs" },
  ...
  overhead_press: { slot: "primary", pattern: "push_v", targets: ["strength"], load: { shoulder: 2, elbow: 2, wrist: 2 }, level: 2, prog: "load", dose: d(4, 6, REST.long, { rpe: 8 }), region: "shoulders" },
  ...
  power_clean: { slot: "primary", pattern: "jump", targets: ["strength", "speed"], load: { knee: 2, lower_back: 1, quad: 2, calf: 1, glute: 2, wrist: 2 }, level: 3, prog: "load", dose: d(5, 3, REST.full, { rpe: 8, tempo: "Explosive" }), region: "legs" },
  box_jumps: { slot: "primary", pattern: "jump", targets: ["strength", "speed"], load: { knee: 2, ankle: 2, quad: 2, calf: 2, glute: 2 }, level: 2, prog: "load", dose: d(4, 4, REST.full, { rpe: 7 }), region: "impact" },
  broad_jump: { slot: "primary", pattern: "jump", targets: ["strength", "speed"], load: { knee: 2, ankle: 1, quad: 2, calf: 2, glute: 2 }, level: 2, prog: "load", dose: d(4, 4, REST.full, { rpe: 7 }), region: "impact" },
  vertical_jump: { slot: "primary", pattern: "jump", targets: ["strength", "speed"], load: { knee: 2, ankle: 1, quad: 2, calf: 2, glute: 2 }, level: 2, prog: "load", dose: d(4, 4, REST.full, { rpe: 7 }), region: "impact" },
  depth_drop: { slot: "primary", pattern: "jump", targets: ["speed", "strength"], load: { knee: 3, ankle: 2, quad: 3, calf: 3, glute: 2 }, level: 3, prog: "load", dose: d(4, 3, REST.full, { rpe: 8 }), region: "impact" },
  flying_sprints: { slot: "primary", pattern: "sprint", targets: ["speed"], load: { hamstring: 2, knee: 1, quad: 1, calf: 3, groin: 1, glute: 2 }, level: 3, prog: "time", dose: d(5, 20, REST.full, { unit: "metres", rpe: 9 }), region: "conditioning" },
  resisted_sprint: { slot: "primary", pattern: "sprint", targets: ["speed"], load: { hamstring: 2, quad: 1, calf: 2, groin: 1, glute: 3 }, level: 2, prog: "load", dose: d(6, 15, REST.full, { unit: "metres", rpe: 9 }), region: "conditioning" },
  hill_sprints: { slot: "primary", pattern: "sprint", targets: ["speed", "endurance"], load: { hamstring: 1, quad: 2, calf: 3, groin: 1, glute: 3 }, level: 2, prog: "reps", dose: d(6, 30, REST.full, { unit: "metres", rpe: 9 }), region: "conditioning" },
  stride_outs: { slot: "primary", pattern: "sprint", targets: ["speed"], load: { hamstring: 1, calf: 2, glute: 2 }, level: 1, prog: "reps", dose: d(5, 60, REST.long, { unit: "metres", rpe: 7 }), region: "conditioning" },
  t_drill: { slot: "primary", pattern: "cod", targets: ["agility", "speed"], load: { knee: 1, ankle: 1, quad: 1, calf: 2, groin: 2, glute: 1 }, level: 2, prog: "time", dose: d(5, 1, REST.full, { rpe: 9 }), region: "conditioning" },
  ...
  goblet_squat: { slot: "secondary", pattern: "squat", targets: ["strength"], load: { knee: 1, quad: 1, groin: 1, glute: 1 }, level: 1, prog: "load", dose: d(3, 10, REST.moderate, { rpe: 7 }), region: "legs" },
  hip_thrust: { slot: "secondary", pattern: "hinge", targets: ["strength"], load: { hamstring: 1, glute: 3 }, level: 1, prog: "load", dose: d(3, 10, REST.moderate, { rpe: 8 }), region: "legs" },
  single_leg_rdl: { slot: "secondary", pattern: "hinge", targets: ["strength", "injury_recovery", "speed"], load: { hamstring: 1, glute: 2 }, level: 2, prog: "load", dose: d(3, 8, REST.moderate, { unit: "each side", rpe: 7, tempo: "3s down" }), region: "legs" },
  bulgarian_split: { slot: "secondary", pattern: "lunge", targets: ["strength"], load: { knee: 2, hip: 1, quad: 2, groin: 1, glute: 2 }, level: 2, prog: "load", dose: d(3, 8, REST.moderate, { unit: "each side", rpe: 8 }), region: "legs" },
  ...
  pogo_hops: { slot: "secondary", pattern: "jump", targets: ["speed", "strength"], load: { ankle: 2, calf: 3, glute: 1 }, level: 2, prog: "reps", dose: d(4, 12, REST.short, { rpe: 7 }), region: "impact" },
  lateral_shuffle: { slot: "secondary", pattern: "cod", targets: ["agility"], load: { knee: 1, ankle: 1, quad: 1, calf: 1, groin: 2, glute: 2 }, level: 1, prog: "time", dose: d(4, 20, REST.moderate, { unit: "secs", rpe: 8 }), region: "conditioning" },
  reactive_mirror: { slot: "secondary", pattern: "cod", targets: ["agility"], load: { calf: 1, groin: 2 }, level: 2, prog: "time", dose: d(4, 20, REST.moderate, { unit: "secs", rpe: 8 }), region: "conditioning" },
  defensive_slides: { slot: "secondary", pattern: "cod", targets: ["agility"], load: { knee: 1, quad: 1, calf: 1, groin: 2, glute: 2 }, level: 1, prog: "time", dose: d(4, 25, REST.moderate, { unit: "secs", rpe: 8 }), region: "conditioning" },
  ...
  // is the reps.
  nordic_curl: { slot: "accessory", pattern: "hinge", targets: ["strength", "injury_recovery", "speed"], load: { hamstring: 2, glute: 1 }, level: 2, prog: "reps", dose: d(3, 6, REST.moderate, { tempo: "Resist the lower" }), region: "legs" },
  copenhagen: { slot: "accessory", pattern: "core", targets: ["strength", "injury_recovery"], load: { hip: 1, groin: 3 }, level: 2, prog: "time", dose: d(3, 20, REST.short, { unit: "secs" }), region: "core" },
  spanish_squat: { slot: "accessory", pattern: "squat", targets: ["injury_recovery"], load: { knee: 1, quad: 2, glute: 1 }, level: 1, prog: "time", dose: d(3, 30, REST.short, { unit: "secs" }), region: "legs" },
  band_lateral_walk: { slot: "accessory", pattern: "rehab", targets: ["injury_recovery", "strength"], load: { groin: 1, glute: 2 }, level: 1, prog: "reps", dose: d(3, 12, REST.short, { unit: "each side" }), region: "legs" },
  ...
  farmers_carry: { slot: "accessory", pattern: "carry", targets: ["strength", "endurance"], load: { elbow: 1, wrist: 3 }, level: 1, prog: "load", dose: d(3, 30, REST.moderate, { unit: "metres", rpe: 8 }), region: "core" },
  ...
  hamstring_slider: { slot: "accessory", pattern: "hinge", targets: ["injury_recovery", "speed"], load: { hamstring: 1, glute: 1 }, level: 2, prog: "reps", dose: d(3, 8, REST.short, { tempo: "Slow out" }), region: "legs" },
  ...
  long_run: { slot: "conditioning", pattern: "conditioning", targets: ["endurance"], load: { knee: 2, ankle: 2, hamstring: 2, hip: 1, quad: 1, calf: 2, glute: 1 }, level: 2, prog: "time", dose: d(1, 75, REST.none, { unit: "minutes", rpe: 5 }), region: "running" },
  threshold_run: { slot: "conditioning", pattern: "conditioning", targets: ["endurance"], load: { knee: 2, ankle: 2, hamstring: 2, quad: 1, calf: 2, glute: 1 }, level: 2, prog: "time", dose: d(1, 30, REST.none, { unit: "minutes", rpe: 8 }), region: "running" },
  vo2_intervals: { slot: "conditioning", pattern: "conditioning", targets: ["endurance"], load: { knee: 2, ankle: 2, hamstring: 2, quad: 1, calf: 2 }, level: 3, prog: "time", dose: d(5, 3, REST.long, { unit: "minutes", rpe: 9 }), region: "running" },
  ...
  hill_repeats: { slot: "conditioning", pattern: "conditioning", targets: ["endurance", "strength"], load: { knee: 2, ankle: 2, hamstring: 2, quad: 2, calf: 3, glute: 2 }, level: 2, prog: "reps", dose: d(8, 60, REST.moderate, { unit: "secs", rpe: 8 }), region: "running" },
  // A primer, not a session — which is why it warms up rather than conditions.
  strides: { slot: "warmup", pattern: "sprint", targets: ["speed"], load: { knee: 2, ankle: 2, hamstring: 2, quad: 1, calf: 2, glute: 2 }, level: 1, prog: "reps", dose: d(5, 20, REST.short, { unit: "secs", rpe: 6 }), region: "running" },
  ...
  ski_erg: { slot: "conditioning", pattern: "conditioning", targets: ["endurance"], load: { shoulder: 1, elbow: 1 }, level: 2, prog: "time", dose: d(6, 45, REST.moderate, { unit: "secs", rpe: 8 }), region: "conditioning" },
  ...
  sled_push: { slot: "conditioning", pattern: "conditioning", targets: ["endurance", "strength"], load: { knee: 1, quad: 2, calf: 2, glute: 2 }, level: 2, prog: "load", dose: d(6, 20, REST.moderate, { unit: "metres", rpe: 8 }), region: "conditioning" },
  kb_swing_intervals: { slot: "conditioning", pattern: "hinge", targets: ["endurance", "strength"], load: { lower_back: 1, hamstring: 1, groin: 1, glute: 2, wrist: 1 }, level: 2, prog: "time", dose: d(6, 30, REST.short, { unit: "secs", rpe: 8 }), region: "conditioning" },
  shuttle_runs: { slot: "conditioning", pattern: "cod", targets: ["endurance", "agility"], load: { knee: 1, ankle: 1, quad: 1, calf: 2, groin: 1, glute: 1 }, level: 2, prog: "time", dose: d(8, 20, REST.moderate, { unit: "metres", rpe: 9 }), region: "conditioning" },
  stair_intervals: { slot: "conditioning", pattern: "conditioning", targets: ["endurance"], load: { knee: 1, quad: 2, calf: 3, glute: 2 }, level: 2, prog: "time", dose: d(8, 30, REST.moderate, { unit: "secs", rpe: 8 }), region: "conditioning" },
  ...
  crossing_drill: { slot: "skill", pattern: "skill", targets: ["skill"], load: { groin: 2 }, level: 2, prog: "skill", dose: d(4, 8, REST.short), region: "skill" },
  finishing_drill: { slot: "skill", pattern: "skill", targets: ["skill"], load: { groin: 2 }, level: 2, prog: "skill", dose: d(5, 8, REST.short), region: "skill" },
  heading_drill: { slot: "skill", pattern: "skill", targets: ["skill"], load: {}, level: 2, prog: "skill", dose: d(4, 8, REST.short), region: "skill" },
  long_passing: { slot: "skill", pattern: "skill", targets: ["skill"], load: { groin: 2 }, level: 2, prog: "skill", dose: d(4, 10, REST.short), region: "skill" },
  ...
  set_piece_practice: { slot: "skill", pattern: "skill", targets: ["skill"], load: { groin: 2 }, level: 2, prog: "skill", dose: d(4, 8, REST.short), region: "skill" },
  tackle_technique: { slot: "skill", pattern: "skill", targets: ["skill"], load: { shoulder: 1, groin: 2 }, level: 2, prog: "skill", dose: d(4, 6, REST.moderate), region: "skill" },
  ...
  gk_diving: { slot: "skill", pattern: "skill", targets: ["skill"], load: { shoulder: 1, groin: 2, elbow: 1, wrist: 2 }, level: 2, prog: "skill", dose: d(4, 6, REST.moderate, { unit: "each side" }), region: "skill" },
