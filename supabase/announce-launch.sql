  ...
  <tr><td style="padding-bottom:26px;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
      ...
      <tr><td align="center" style="padding:0 4px;">
        ...
        <div class="pa-h" style="font-size:22px;font-weight:800;color:#0e1411;">75</div>
  ...
  <tr><td style="padding-bottom:18px;">
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%"><tr>
      ...
      <td valign="top">
        ...
        <div class="pa-body" style="font-size:14px;line-height:1.55;color:#495751;">136 challenges, 75 badges and a rank ladder from Iron to Legend. It pays you for rest days too, not just for grinding.</div>
      </td>
    </tr></table>
  </td></tr>
  ...
  if p_test_to is not null then
    ...
    perform net.http_post(
      ...
      body    := jsonb_build_object(
        ...
        'subject', '[TEST 4f7c0429801e] ' || v_subj,
...
select case
         when p.prosrc like '%copy-id: 4f7c0429801e%'
           then 'INSTALLED - new copy is live (copy-id 4f7c0429801e). Send yourself a test.'
